...
describe 'sahara::keystone::authtoken' do
  ...
  shared_examples 'sahara::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('sahara_config').with(
          :username                       => 'sahara',
          :password                       => 'sahara_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'sahara::keystone::authtoken'
    end
  end
