...
describe 'sahara::keystone::authtoken' do

  let :params do
    { :password => 'sahara_password', }
  end

  shared_examples 'sahara authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_sahara_config('keystone_authtoken/username').with_value('sahara')
        is_expected.to contain_sahara_config('keystone_authtoken/password').with_value('sahara_password')
        is_expected.to contain_sahara_config('keystone_authtoken/auth_url').with_value('http://127.0.0.1:35357/')
        is_expected.to contain_sahara_config('keystone_authtoken/project_name').with_value('services')
        is_expected.to contain_sahara_config('keystone_authtoken/user_domain_name').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/project_domain_name').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_sahara_config('keystone_authtoken/keyfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_conn_get_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_dead_retry').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_maxsize').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_socket_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_unused_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_secret_key').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_security_strategy').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_use_advanced_pool').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_sahara_config('keystone_authtoken/memcached_servers').with_value('<SERVICE DEFAULT>')
...
['memcached01:11211','memcached02:11211'],
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_sahara_config('keystone_authtoken/project_name').with_value(params[:project_name])
        is_expected.to contain_sahara_config('keystone_authtoken/user_domain_name').with_value(params[:user_domain_name])
        is_expected.to contain_sahara_config('keystone_authtoken/project_domain_name').with_value(params[:project_domain_name])
        is_expected.to contain_sahara_config('keystone_authtoken/insecure').with_value(params[:insecure])
        is_expected.to contain_sahara_config('keystone_authtoken/auth_section').with_value(params[:auth_section])
        is_expected.to contain_sahara_config('keystone_authtoken/auth_type').with_value(params[:auth_type])
        is_expected.to contain_sahara_config('keystone_authtoken/auth_version').with_value(params[:auth_version])
        ...
        is_expected.to contain_sahara_config('keystone_authtoken/keyfile').with_value(params[:keyfile])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_conn_get_timeout').with_value(params[:memcache_pool_conn_get_timeout])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_dead_retry').with_value(params[:memcache_pool_dead_retry])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_maxsize').with_value(params[:memcache_pool_maxsize])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_socket_timeout').with_value(params[:memcache_pool_socket_timeout])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_pool_unused_timeout').with_value(params[:memcache_pool_unused_timeout])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_secret_key').with_value(params[:memcache_secret_key])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_security_strategy').with_value(params[:memcache_security_strategy])
        is_expected.to contain_sahara_config('keystone_authtoken/memcache_use_advanced_pool').with_value(params[:memcache_use_advanced_pool])
        is_expected.to contain_sahara_config('keystone_authtoken/memcached_servers').with_value('memcached01:11211,memcached02:11211')
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'sahara authtoken'
    end
  end
